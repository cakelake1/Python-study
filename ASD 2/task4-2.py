...
# 4.9  Метод, который "переворачивает" связный список.
# В принципе я так и сделал, как в рекомендации, но подругому обозвал свои шаги

# 4.10 Проверка, имеются ли циклы внутри списка.
# Ох, я нагуглил интересный алгоритм(Флойда), а достаточно было просто пройтись циклом по элементам.

# 4.11 Сортировка списка.
# Я рассматривал сортировку пузырьком, как и другие сортировки

# 4.12 Слияние списков.
# Тоже в принципе так и сделал, как в рекомендация.

# 4.13 Dummy
# Проверка на Dummy узел достаточно интересная, думаю в дальнейшем мы будем его использовать.
# Основная идея в том, что с помощью небольшого кода упрощаем логику основного алгоритма.
