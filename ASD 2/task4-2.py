...
# 4.10  Метод, который "переворачивает" связный список.
# В принципе я так и сделал, как в рекомендации, но подругому обозвал свои шаги

# 4.11 Проверка, имеются ли циклы внутри списка.
# Ох, я нагуглил интересный алгоритм(Флойда), а достаточно было просто пройтись циклом по элементам.

# 4.12 Сортировка списка.
# Я рассматривао сортировку пузырьком, как и другие сортировки

# 4.13 Слияние списков.
# Тоже в принципе так и сделал, как в рекомендация.

# 4.14 Dummy
# Проверка на Dummy узел достаточно интересная, думаю в дальнейшем мы будеи его использовать