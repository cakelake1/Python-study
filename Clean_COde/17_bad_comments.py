...
#     b = b.zfill(len(a)) #13.Шум п.4, убираем комментарий. Дополняем меньшее число нулями
#     list = []
#     debt = 0
#     for i in range(len(a)-1, -1, -1): #14. Шум п.4, убираем комментарий Вычитаем справа налево
...
#     return result  or '0' #15. Шум п.4 и п.9 Нелокальная информация-убираем комментарий нужно ли тут ноль выставлять, чтобы None не получилось - нужно!! при вычитании например 100-100 пулучится 0
