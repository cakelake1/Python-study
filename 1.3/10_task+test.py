...
На первый взгляд нужно подставить все ключи по значению и при получению строки посчитать сумму значений. Если в таблице ключа нет, то значение 23, это тоже нужно учесть, еще не знаю как реализовать, по ощущениям можно сделать проверку по ключу и если его нет то давать значение 23 или я вижу есть проверка по ключу  и если ключ отсутствует, то давать значение. А может быть лучше проверить на наличиче ключа и если его нет - добавить в словарь  """